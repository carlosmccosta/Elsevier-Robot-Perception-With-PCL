...
\begin{figure}[hb]
	\centering
	\includegraphics[width=0.16\textwidth]{localization-system-evaluation/testing-platforms/jarvis}
...
\begin{figure}[hb]
	\centering
	\includegraphics[width=0.14\textwidth]{localization-system-evaluation/testing-platforms/pioneer-3dx}
...
\begin{figure}[ht]
	\centering
	\includegraphics[width=0.26\textwidth]{localization-system-evaluation/testing-environments/kinect-flying-arena}
